...
describe Sorter do
  describe '#sort' do
    let(:parsed_data) do
      [
        ...
        { 'last_name' => 'Parker', 'first_name' => 'Matteo',
          'campus' => 'Melbourne', 'favorite_color' => 'Burnt Sienna',
          'date_of_birth' => '2/14/1962' },
        { 'last_name' => 'Cummerata', 'first_name' => 'Elliot',
          'campus' => 'New York City', 'favorite_color' => 'Neon Carrot',
          'date_of_birth' => '4/3/1947' },
    ...
    context 'when last name desc' do
