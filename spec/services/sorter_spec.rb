  ...
  describe "#sort" do
    let(:parsed_data) do
      [
        ...
        {"last_name"=>"Nolan", "first_name"=>"Rhiannon", "middle_initial"=>"O", "campus"=>"Los Angeles", "date_of_birth"=>"10-4-1974", "favorite_color"=>"Vivid Tangerine"},
        {"last_name"=>"Wilkinson", "first_name"=>"Stacy", "middle_initial"=>"D", "campus"=>"New York City", "date_of_birth"=>"1-22-1964", "favorite_color"=>"Shocking Pink"},
        {"last_name"=>"Bruen", "first_name"=>"Rigoberto", "middle_initial"=>"F", "campus"=>"San Francisco", "date_of_birth"=>"12-1-1962", "favorite_color"=>"Raw Umber"},
